...
unix{
 ...
 LIBS += -L$$HOME_BASE/thirdparty/lib -lyangrtc2   -lpthread -lasound -ldl  -lssl2 -lcrypto2  -lsrtp2
}
win32{
    INCLUDEPATH += $$HOME_BASE\include
    CONFIG(debug, debug|release) {
    ...
    LIBS +=  -lyangrtc2 -lksuser -lwinmm  -lole32 -lStrmiids -lsrtp2 -lavutil -lavcodec
