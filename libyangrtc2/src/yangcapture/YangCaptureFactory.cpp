...
YangVideoCapture *YangCaptureFactory::createVideoCapture(YangVideoInfo *pcontext){
#ifndef _WIN32
...
YangVideoCapture *YangCaptureFactory::createRecordVideoCapture(YangVideoInfo *pcontext){
#ifndef _WIN32
	return new YangVideoCaptureImpl(pcontext);
#else
	return new YangWinVideoCapture(pcontext);
