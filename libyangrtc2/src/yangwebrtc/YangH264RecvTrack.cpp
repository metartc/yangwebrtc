...
int32_t YangH264RecvTrack::put_frame_mixvideo(char *p, int64_t timestamp,
		int32_t nb) {
...
int32_t YangH264RecvTrack::check_send_nacks() {
	int32_t err = Yang_Ok;
...
int32_t YangH264RecvTrack::notify(int puid,YangRtcMessageType mess){
