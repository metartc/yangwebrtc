#ifndef SRC_YANGWEBRTC_YANGLOCALSDP_H_
#define SRC_YANGWEBRTC_YANGLOCALSDP_H_

const char* local_sdp_str="o=SRS/4.0.146(Leo) 93937470806864 2 IN IP4 0.0.0.0\n"\
		"s=SRSPlaySession\nt=0 0\na=ice-lite\na=group:BUNDLE 0 1\n"\
...
#endif /* SRC_YANGWEBRTC_YANGLOCALSDP_H_ */
