...
protected:
	...
	bool m_usingMixav;
public:
	YangRecvTrack(int32_t uid,YangRtcContext* pcontext,YangRtcSessionI *session, YangRtcTrack *track_desc,YangRtpBuffer* rtpBuffer,YangMixQueue* pmixque,
			bool is_audio);
...
public:
	YangRtcAudioRecvTrack(int32_t uid,YangRtcContext* conf,YangRtcSessionI *session,
...
class YangRtcVideoRecvTrack: public YangRecvTrack,
		public IYangRtspPacketDecodeHandler {
public:
	YangRtcVideoRecvTrack(int32_t uid,YangRtcContext* conf,YangRtcSessionI *session,
...
public:
	...
	int32_t initialize(YangRtcContext* conf,YangRtcSourceDescription *stream_desc,YangReceiveCallback *cbk,YangRtpBuffer* rtpBuffer);
	int32_t send_rtcp_rr();
	int32_t send_rtcp_xr_rrtr();
	int32_t check_send_nacks();
