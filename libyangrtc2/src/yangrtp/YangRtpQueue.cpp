...
YangNackOption::YangNackOption()
{
    ...
    min_nack_interval = 20 * YANG_UTIME_MILLISECONDS;

    nack_check_interval = 20 * YANG_UTIME_MILLISECONDS;
...
{
    generate_time_ = yang_update_system_time();
...
YangRtpNackForReceiver::YangRtpNackForReceiver(YangRtpRingBuffer* rtp, size_t queue_size)
{
  ...
  //  yang_info("max_queue_size=%u, nack opt: max_count=%d, max_alive_time=%us, first_nack_interval=%" PRId64 ", nack_interval=%" PRId64,
