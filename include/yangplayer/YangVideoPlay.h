...
private:
	...
	Uint8 SDLCALL (*yang_SDL_EventState)(Uint32 type, int32_t state);
	SDL_Thread *SDLCALL
	(*yang_SDL_CreateThread)(SDL_ThreadFunction fn, const char *name, void *data);
	int32_t SDLCALL (*yang_SDL_GetDisplayUsableBounds)(int32_t displayIndex, SDL_Rect * rect);
	...
	SDL_Renderer * SDLCALL (*yang_SDL_CreateRenderer)(SDL_Window * window,int32_t index, Uint32 flags);
	SDL_Texture * SDLCALL (*yang_SDL_CreateTexture)(SDL_Renderer * renderer, Uint32 format, int32_t access, int32_t w,int32_t h);
	int32_t SDLCALL (*yang_SDL_UpdateTexture)(SDL_Texture * texture,const SDL_Rect * rect,const void *pixels, int32_t pitch);
	int32_t SDLCALL (*yang_SDL_RenderClear)(SDL_Renderer * renderer);
	int32_t SDLCALL (*yang_SDL_RenderCopy)(SDL_Renderer * renderer,SDL_Texture * texture, const SDL_Rect * srcrect, const SDL_Rect * dstrect);
	void SDLCALL (*yang_SDL_RenderPresent)(SDL_Renderer * renderer);
	int32_t SDLCALL (*yang_SDL_SetRenderDrawColor)(SDL_Renderer * renderer, Uint8 r, Uint8 g, Uint8 b,Uint8 a);
	int32_t SDLCALL (*yang_SDL_RenderFillRect)(SDL_Renderer * renderer,const SDL_Rect * rect);
	...
	TTF_Font * SDLCALL (*yang_TTF_OpenFont)(const char *file, int32_t ptsize);
	...
	int32_t SDLCALL (*yang_TTF_Init)(void);
};
