...
public:
    ...
    void init(const char *teacherip,unsigned int teacherport,const char *studentip,unsigned int studentport);	//分别 初始化老师和学生定位摄像机的ip
...
private:
    ...
    void sendmsg(string type,char *visca,int len);
