...
class YangVideoStreamFrame {
public:
	YangVideoStreamFrame();
	virtual ~YangVideoStreamFrame();

	void init(int32_t transtype);
	void setVideoData(YangVideoFrame* videoFrame,YangVideoEncDecType videoType=Yang_VED_264);
