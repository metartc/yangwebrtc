...
int32_t YangRtpPacketUtil::on_audio(YangAudioStreamFrame *audioFrame, YangRtpPacket *pkt) {
	...
	pkt->m_header.set_timestamp(audioFrame->getTimestamp());
...
int32_t YangRtpPacketUtil::on_h264_video(YangVideoStreamFrame *videoFrame,
...
int32_t YangRtpPacketUtil::package_single_nalu(YangVideoStreamFrame *videoFrame,
		vector<YangRtpPacket*> &pkts) {
	int32_t err = Yang_Ok;
	...
	pkt->m_header.set_timestamp(videoFrame->getTimestamp());
...
int32_t YangRtpPacketUtil::package_fu_a(YangVideoStreamFrame *videoFrame,
...
int32_t YangRtpPacketUtil::package_stap_a(YangVideoStreamFrame *videoFrame,
		YangRtpPacket *pkt) {
