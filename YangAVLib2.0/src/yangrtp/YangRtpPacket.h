...
public:
	...
	int32_t on_h264_video(YangVideoStreamFrame* videoFrame,vector<YangRtpPacket*> &pkts);
	int32_t on_audio(YangAudioStreamFrame* audioFrame,YangRtpPacket* pkt);
	int32_t package_single_nalu(char* p,int32_t plen, int64_t timestamp,vector<YangRtpPacket*>& pkts);
	int32_t package_single_nalu(YangVideoStreamFrame* videoFrame, vector<YangRtpPacket*>& pkts);
	int32_t package_fu_a(YangVideoStreamFrame* videoFrame,int32_t fu_payload_size, vector<YangRtpPacket*>& pkts);
	int32_t package_stap_a(YangVideoStreamFrame* videoFrame,YangRtpPacket* pkt);
public:
