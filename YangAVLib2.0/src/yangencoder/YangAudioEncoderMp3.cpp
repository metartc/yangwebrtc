...
void YangAudioEncoderMp3::loadLib() {
	...
	yang_lame_init = (lame_global_flags* CDECL (*)(void))m_lib.loadFunction("lame_init");
	yang_lame_init_params=(int32_t CDECL (*)(lame_global_flags *))m_lib.loadFunction("lame_init_params");
	yang_lame_set_preset=(int32_t CDECL (*)( lame_global_flags* gfp, int32_t ))m_lib.loadFunction("lame_set_preset");
	yang_lame_set_in_samplerate=(int32_t CDECL (*)(lame_global_flags *, int))m_lib.loadFunction("lame_set_in_samplerate");
	yang_lame_set_VBR=(int32_t CDECL (*)(lame_global_flags *, vbr_mode))m_lib.loadFunction("lame_set_VBR");
	yang_lame_set_mode=(int32_t CDECL (*)(lame_global_flags *, MPEG_mode))m_lib.loadFunction("lame_set_mode");
	yang_lame_set_num_channels=(int32_t CDECL (*)(lame_global_flags *, int))m_lib.loadFunction("lame_set_num_channels");
	yang_lame_set_brate=(int32_t CDECL (*)(lame_global_flags *, int))m_lib.loadFunction("lame_set_brate");
	yang_lame_set_strict_ISO=(int32_t CDECL (*)(lame_global_flags *, int))m_lib.loadFunction("lame_set_strict_ISO");
	yang_lame_set_original=(int32_t CDECL (*)(lame_global_flags *, int))m_lib.loadFunction("lame_set_original");
	yang_lame_set_error_protection=(int32_t CDECL (*)(lame_global_flags *, int))m_lib.loadFunction("lame_set_error_protection");
	yang_lame_set_extension=(int32_t CDECL (*)(lame_global_flags *, int))m_lib.loadFunction("lame_set_extension");
	yang_lame_set_disable_reservoir=(int32_t CDECL (*)(lame_global_flags *, int))m_lib.loadFunction("lame_set_disable_reservoir");
	yang_lame_set_bWriteVbrTag=(int32_t CDECL (*)(lame_global_flags *, int))m_lib.loadFunction("lame_set_bWriteVbrTag");
	yang_lame_encode_buffer_interleaved=(int32_t CDECL (*)(lame_global_flags* gfp,
			int16_t  pcm[],int32_t num_samples, uint8_t* mp3buf,
			int32_t mp3buf_size ))m_lib.loadFunction("lame_encode_buffer_interleaved");
	yang_lame_close=(int32_t CDECL (*) (lame_global_flags *))m_lib.loadFunction("lame_close");
}
...
/**
 void YangAudioEncoderMp3::encoder(uint8_t *p_buf,int32_t bufLen){
 if(!gfp) return;
 memcpy(temp + m_bufLen, p_buf, bufLen);

 m_bufLen += bufLen;
 if (m_bufLen < dwRead)	return;
 //printf("%d,",m_bufLen);
 memcpy(pWAVBuffer, temp, dwRead);
 dwWrite = yang_lame_encode_buffer_interleaved(gfp, pWAVBuffer, 1152, pMP3Buffer,	0);

 if (dwWrite > 0&&m_pipe) {
 m_pipe->putPipeData(pMP3Buffer, dwWrite);
 ...
 void YangAudioEncoderMp3::encoder(uint8_t *p_buf,int32_t bufLen,uint8_t *p_out,int32_t *outLen){
