...
#include <arpa/inet.h>
#endif
void initYangMeta(YangMeataData *pmd,YangVideoParam *pini){
	pmd->width=pini->outWidth ;
	pmd->height=pini->outHeight;
	pmd->width_align=(pini->outWidth + 15) & (~15);
	pmd->height_align=(pini->outHeight + 15) & (~15);
	pmd->gop_size=20;
