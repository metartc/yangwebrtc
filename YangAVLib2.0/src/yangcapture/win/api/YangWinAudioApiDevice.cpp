#include <yangcapture/win/api/YangWinAudioApiDevice.h>
#ifdef _WIN32
#include <yangutil/yang_unistd.h>
#include <yangutil/yangtype.h>
#include <yangavutil/audio/YangAudioUtil.h>
#include "YangWinAudioApiAec.h"

YangWinAudioApiDevice::YangWinAudioApiDevice(YangAudioInfo *pini,bool isRecord,
	...
	if(!isRecord) m_player = new YangWinAudioApiRenders(pini);
...
void YangWinAudioApiDevice::setInAudioBuffer(
    ...
    if(m_player) m_player->m_audioData.setInAudioBuffer(pal);
