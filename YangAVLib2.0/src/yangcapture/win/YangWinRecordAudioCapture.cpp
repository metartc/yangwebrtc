#include "YangWinRecordAudioCapture.h"
#ifdef _WIN32
#include <stdlib.h>
#include <malloc.h>
#include <unistd.h>
...
YangWinRecordAudioCapture::YangWinRecordAudioCapture(YangAudioInfo *pini) { // @suppress("Class members should be properly initialized")
	m_para = pini;
    m_ahandle = new YangRecAudioCaptureHandle(pini);
...
void YangWinRecordAudioCapture::run() {
	m_isStart=1;
	startLoop();
	m_isStart=0;
}
