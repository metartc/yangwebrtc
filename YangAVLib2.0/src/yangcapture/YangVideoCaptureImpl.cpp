...
YangVideoCaptureImpl::YangVideoCaptureImpl(YangVideoInfo *pini) {

	m_para = pini;

	m_vhandle = new YangVideoCaptureHandle(pini);
...
int32_t YangVideoCaptureImpl::read_buffer() {
	...
	//if(cameraIndex==2) printf("%d-%d,",m_user_buffer[m_buf.index].length,1920*1080*3/2);
	if (m_vhandle)
