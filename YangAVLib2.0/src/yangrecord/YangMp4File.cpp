...
YangMp4File::YangMp4File(char *fileName, YangVideoInfo *pini) {
	m_ini = pini;
	...
	m_tick = 0;
	m_cou = 0;
	m_interval = 2 * (1000 / m_ini->frame) * 90;
	m_interval1 = 2 * (1000 / m_ini->frame);
