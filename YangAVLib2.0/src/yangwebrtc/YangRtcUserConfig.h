#ifndef SRC_YANGWEBRTC_YANGRTCUSERCONFIG_H_
#define SRC_YANGWEBRTC_YANGRTCUSERCONFIG_H_
...
struct YangRtcUserConfig{
	std::string codec_;
	YangStreamConfig* streamConf;
	YangAudioInfo* local_audio;
	YangVideoInfo* local_video;
    YangRtcInfo* rtc_info;
...
#endif /* SRC_YANGWEBRTC_YANGRTCUSERCONFIG_H_ */
