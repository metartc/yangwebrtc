...
int32_t  (*yang_SDL_WaitEvent)(SDL_Event *event);
int32_t  (*yang_SDL_PushEvent)(SDL_Event *event);
...
void YangVideoPlay::loadLib() {
    ...
    yang_SDL_Init = (int32_t  (*)(Uint32 flags)) m_lib.loadFunction(
			"SDL_Init");
	yang_SDL_EventState =
            (Uint8  (*)(Uint32 type, int32_t state)) m_lib.loadFunction(
					"SDL_EventState");
    yang_SDL_CreateThread = (SDL_Thread*
	(*)(SDL_ThreadFunction fn, const char *name, void *data))m_lib.loadFunction("SDL_CreateThread");;
    yang_SDL_WaitEvent = (int32_t  (*)(SDL_Event *event)) m_lib.loadFunction(
			"SDL_WaitEvent");
	;
    yang_SDL_PushEvent = (int32_t  (*)(SDL_Event *event)) m_lib.loadFunction(
			"SDL_PushEvent");
	;
    yang_SDL_Delay = (void  (*)(Uint32 ms)) m_lib.loadFunction(
			"SDL_Delay");
	;
    yang_SDL_GetDisplayUsableBounds = (int32_t  (*)(int32_t displayIndex,
			SDL_Rect *rect)) m_lib.loadFunction("SDL_GetDisplayUsableBounds");
	;

    yang_SDL_CreateWindow = (SDL_Window*  (*)(const char *title,
	...
	yang_SDL_UpdateTexture =
            (int32_t  (*)(SDL_Texture *texture, const SDL_Rect *rect,
					const void *pixels, int32_t pitch)) m_lib.loadFunction(
					"SDL_UpdateTexture");
	yang_SDL_RenderClear =
            (int32_t  (*)(SDL_Renderer *renderer)) m_lib.loadFunction(
					"SDL_RenderClear");
    yang_SDL_RenderCopy = (int32_t  (*)(SDL_Renderer *renderer,
			SDL_Texture *texture, const SDL_Rect *srcrect,
			const SDL_Rect *dstrect)) m_lib.loadFunction("SDL_RenderCopy");
	yang_SDL_RenderPresent =
            (void  (*)(SDL_Renderer *renderer)) m_lib.loadFunction(
					"SDL_RenderPresent");
    yang_SDL_SetRenderDrawColor = (int32_t  (*)(SDL_Renderer *renderer,
			Uint8 r, Uint8 g, Uint8 b, Uint8 a)) m_lib.loadFunction(
			"SDL_SetRenderDrawColor");
    yang_SDL_RenderFillRect = (int32_t  (*)(SDL_Renderer *renderer,
			const SDL_Rect *rect)) m_lib.loadFunction("SDL_RenderFillRect");
	yang_SDL_DestroyTexture =
            (void  (*)(SDL_Texture *texture)) m_lib.loadFunction(
					"SDL_DestroyTexture");
	yang_SDL_DestroyRenderer =
            (void  (*)(SDL_Renderer *renderer)) m_lib.loadFunction(
					"SDL_DestroyRenderer");
	yang_SDL_DestroyWindow =
            (void  (*)(SDL_Window *window)) m_lib.loadFunction(
					"SDL_DestroyWindow");
	yang_SDL_FreeSurface =
            (void  (*)(SDL_Surface *surface)) m_lib.loadFunction(
					"SDL_FreeSurface");
    ...
    yang_TTF_CloseFont = (void  (*)(TTF_Font *font)) m_lib1.loadFunction(
			"TTF_CloseFont");
