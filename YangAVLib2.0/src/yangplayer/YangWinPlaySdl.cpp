...
void YangWinPlaySdl::loadLib(){
    yang_SDL_Init=(int32_t  (*)(Uint32 flags))m_lib.loadFunction("SDL_Init");
    yang_SDL_EventState=(Uint8  (*)(Uint32 type, int32_t state)) m_lib.loadFunction("SDL_EventState");
    yang_SDL_CreateWindowFrom=(SDL_Window *  (*)(const void *data))m_lib.loadFunction("SDL_CreateWindowFrom");
    yang_SDL_CreateRenderer=(SDL_Renderer *  (*)(SDL_Window * window,int32_t index, Uint32 flags))m_lib.loadFunction("SDL_CreateRenderer");
    yang_SDL_CreateTexture=(SDL_Texture *  (*)(SDL_Renderer * renderer, Uint32 format, int32_t access, int32_t w,int32_t h))m_lib.loadFunction("SDL_CreateTexture");
    yang_SDL_UpdateTexture=(int32_t  (*)(SDL_Texture * texture,const SDL_Rect * rect,const void *pixels, int32_t pitch))m_lib.loadFunction("SDL_UpdateTexture");
    yang_SDL_RenderClear=(int32_t  (*)(SDL_Renderer * renderer))m_lib.loadFunction("SDL_RenderClear");
    yang_SDL_RenderCopy=(int32_t  (*)(SDL_Renderer * renderer,SDL_Texture * texture, const SDL_Rect * srcrect, const SDL_Rect * dstrect))m_lib.loadFunction("SDL_RenderCopy");
    yang_SDL_RenderPresent=(void  (*)(SDL_Renderer * renderer))m_lib.loadFunction("SDL_RenderPresent");
    yang_SDL_SetRenderDrawColor=(int32_t  (*)(SDL_Renderer * renderer, Uint8 r, Uint8 g, Uint8 b,Uint8 a))m_lib.loadFunction("SDL_SetRenderDrawColor");
    yang_SDL_RenderFillRect=(int32_t  (*)(SDL_Renderer * renderer,const SDL_Rect * rect))m_lib.loadFunction("SDL_RenderFillRect");
    yang_SDL_DestroyTexture=(void  (*)(SDL_Texture * texture))m_lib.loadFunction("SDL_DestroyTexture");
    yang_SDL_DestroyRenderer=(void  (*)(SDL_Renderer * renderer))m_lib.loadFunction("SDL_DestroyRenderer");
    yang_SDL_DestroyWindow=(void  (*)(SDL_Window * window))m_lib.loadFunction("SDL_DestroyWindow");
    yang_SDL_FreeSurface=(void  (*)(SDL_Surface * surface))m_lib.loadFunction("SDL_FreeSurface");
    yang_SDL_CreateTextureFromSurface=(SDL_Texture *  (*)(SDL_Renderer * renderer, SDL_Surface * surface))m_lib.loadFunction("SDL_CreateTextureFromSurface");
    yang_SDL_GetError=(const char * (*)(void))m_lib.loadFunction("SDL_GetError");

#ifndef _WIN32
    yang_TTF_Init=(int32_t  (*)(void))m_lib1.loadFunction("TTF_Init");
    yang_TTF_OpenFont=(TTF_Font *  (*)(const char *file, int32_t ptsize))m_lib1.loadFunction("TTF_OpenFont");
    yang_TTF_RenderUTF8_Blended=(SDL_Surface *  (*)(TTF_Font *font, const char *text, SDL_Color fg))m_lib1.loadFunction("TTF_RenderUTF8_Blended");
    yang_TTF_CloseFont=(void  (*)(TTF_Font *font))m_lib1.loadFunction("TTF_CloseFont");
#endif
